    ...
    <div class="max-w-4xl mx-auto mt-12 px-4">
        @if($vehicleData)
            ...
            <div class="mt-10 text-center">
                ...
                <div id="vehicleDataContent" class="hidden text-left bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
                        ...
                        @foreach($vehicleData as $key => $value)
                            @php
                                ...
                                elseif (is_numeric($value)) {
                                    ...
                                    // Massa/gewicht in kg/cm³/liter etc.
                                    elseif (Str::contains($key, ['massa', 'gewicht'])) {
                                        $formattedValue = number_format($value, 0, ',', ',') . ' kg';
                                    }
                                    // Cilinderinhoud in cc
                                     elseif (Str::contains($key, ['inhoud'])) {
                                        $formattedValue = number_format($value, 0, ',', ',') . ' cc';
                                    }
                                    // Snelheid
