<div class="max-w-7xl mx-auto p-8 bg-white rounded-lg shadow-lg border border-gray-200">
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="flex-1">
            ...
            <div class="mb-6 border border-gray-200 rounded-md p-4">
                <div class="flex items-center space-x-2 text-sm text-gray-700 mb-2">
                    <span class="bg-gray-200 rounded-md px-3 py-1">Shipping</span>
                    <span>Flat rate: <strong>€ {{ number_format($shippingCost ?? 0, 2, ',', '.') }}</strong></span>
                </div>
            </div>
            ...
            <form method="POST" action="" class="bg-gray-50 rounded-md p-6 shadow-inner" novalidate>
                ...
                <fieldset class="space-y-6 mb-6">
                    <legend class="text-lg font-semibold text-gray-800 mb-4">Choose your payment method</legend>
                            ...
                            <div>
                                ...
                                <div class="{{ $paymentMethod === 'cc' && $key === 'cc' ? 'block' : 'hidden' }}">
                                    <div class="flex items-center gap-2">
                                        ...
                                        @else
                                            <span class="mt-8 ml-[16px] text-gray-500 text-sm">No card type detected</span>
                                        @endif
                                    </div>
        ...
        <aside class="w-full lg:w-96 bg-white border rounded-lg p-6 shadow-sm">
            <h2 class="font-bold text-2xl mb-4">Overview</h2>
            ...
            <div class="overflow-y-auto max-h-60 mb-4">
                <table class="w-full">
                    <thead>
                    <tr>
                        <th class="border-b border-gray-300 pb-2 text-left text-[18px]">Product</th>
                        <th class="border-b border-gray-300 pb-2 text-right text-[18px]">Subtotal</th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($cart as $item)
                        <tr>
                            <td class="border-b border-gray-200 py-2">
                                ...
                                <p class="text-sm text-gray-600">Items: {{ $item['quantity'] }}</p>
                            </td>
