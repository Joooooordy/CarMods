<section class="w-full">
    ...
    <x-settings.admin-layout :heading="__('Profile')" :subheading="__('Update your profile information')">
        ...
        {{ __('Click the image to choose a new avatar!') }}
            ...
            <flux:fieldset class="border border-gray-300 rounded-lg p-6 shadow-inner bg-white dark:bg-gray-800">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <flux:input label="Street address" placeholder="123 Main St" wire:model="street"
                                    class="rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition"/>
                        <flux:input label="House number" placeholder="42A" wire:model="house_nr"
                                    class="rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition"/>
                    </div>
                    <div class="grid grid-cols-2 gap-x-4 gap-y-6">
                        <flux:input label="City" placeholder="Amsterdam" wire:model="city"
                                    class="rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition"/>
                        <flux:input label="State / Province" placeholder="Noord-Holland" wire:model="state"
                                    class="rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition"/>
                        <flux:input label="Postal / Zip code" placeholder="1234 AB" wire:model="zipcode"
                                    class="rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition"/>
                        <flux:select label="Country" wire:model="country"
                                     class="rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition">
